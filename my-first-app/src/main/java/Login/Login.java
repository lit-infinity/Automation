...
//	invalid credentials
	...
	public void invalidLogin() {
	    ...
	    driver.findElement(By.id("email")).sendKeys("vanita231966@outlook.com");
	    driver.findElement(By.id("password")).sendKeys("Vanita@1234");
...
//	login with valid credentials
	...
	public void validLogin() throws Exception {
    	...
    	email.clear();
    	email.sendKeys("vanita231966@outlook.com");

    	WebElement password = driver.findElement(By.id("password"));
    	password.clear();
    	password.sendKeys("Vanita@123");
        driver.findElement(By.className("btn-primary")).click();
